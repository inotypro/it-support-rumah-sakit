                    ...
                    <div class="welcome-content bg-white bg-opacity-90 p-5 rounded-3 shadow-lg">
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body text-center p-5">
                                ...
                                <p class="card-text">Penilaian Anda telah berhasil disimpan. Masukan Anda sangat berharga untuk peningkatan layanan kami.</p>
                                <div class="mt-4">
                                    <a href="{{ route('welcome') }}" class="btn btn-primary">
                                        <i class="fas fa-home me-2"></i>Kembali ke Beranda
                                    </a>
                                    <a href="{{ route('surveys.create') }}" class="btn btn-outline-primary">
                                        <i class="fas fa-star me-2"></i>Buat Penilaian Baru
                                    </a>
                                </div>
                            </div>
                        </div>
